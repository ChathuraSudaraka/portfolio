  ...
  const sections = [
    {
      ...
      content: "I value your privacy and am transparent about the data collected through my portfolio.",
      subsections: [
    ...
    },
    {
      ...
      content: "Your information is handled with care and used only for specific purposes.",
      subsections: [
        ...
        <div className="text-center mb-12">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-primary/10 dark:bg-primary/20 px-4 py-2 rounded-full mb-4">
              ...
              <p className="text-sm font-medium text-primary">Legal Documents</p>
            </div>
