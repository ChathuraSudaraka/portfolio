        ...
        <div className="flex items-center justify-between">
          ...
          <div className="lg:block hidden">
            <a
              ...
              class="relative inline-flex items-center justify-center p-4 px-4 py-2 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-lg shadow-md group"
            >
              ...
              <span class="relative invisible">Contact Me</span>
            </a>
          </div>
