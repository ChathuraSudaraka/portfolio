  ...
  const educations = [
    {
      ...
      duration: "2022-2026",
      description: "The Java Institute for Advanced Technology is a prominent research-oriented higher education institution based in Sri Lanka, fostering innovation and excellence. Focusing on software architecture, cloud computing, and enterprise development."
    },
    {
      degree: "Diploma In Information Technology (DIT)",
      school: "ESOFT Metro Campus",
      duration: "2022-2023",
      description: "Comprehensive study of modern software development practices, database management, and web technologies. Achieved distinction with special focus on full-stack development."
    },
    {
      degree: "Advanced Level in Technology Stream",
      school: "Richmond College",
      duration: "2019-2021",
      description: "Studied Engineering Technology, Science for Technology, and ICT. Participated in various tech competitions and coding challenges. Led the school's programming club."
    },
    {
      degree: "Professional Certification in Web Development",
      school: "FreeCodeCamp",
      duration: "2021-2022",
      description: "Completed intensive online coursework in modern web development, including responsive web design, JavaScript algorithms, and frontend libraries."
    }
  ];
      ...
      <div className="container px-4">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-secondary/10 dark:bg-secondary/20 px-3 py-2 rounded-full mb-4">
            ...
            <p className="text-sm font-medium text-secondary">Academic Journey</p>
          </div>
              ...
              >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 top-0 z-10">
                  <div className="w-5 h-5 relative">
                    <div className="absolute inset-0 rounded-full bg-secondary/20 dark:bg-secondary/40 animate-ping" />
                ...
                <div className={`md:col-span-1 ${index % 2 === 0 ? "md:col-start-1" : "md:col-start-2"}`}>
                  <div className="group relative bg-white/50 dark:bg-black/50 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-800/50 p-6 hover:shadow-lg transition-all duration-300">
                    ...
                    <div className="relative z-10">
                      <div className="text-xl font-bold text-secondary mb-2">{edu.degree}</div>
